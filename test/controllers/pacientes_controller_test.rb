...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { analista_id: @paciente.analista_id, endereco: @paciente.endereco, nome: @paciente.nome, situacao_paciente_id: @paciente.situacao_paciente_id, telefone: @paciente.telefone } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { analista_id: @paciente.analista_id, endereco: @paciente.endereco, nome: @paciente.nome, situacao_paciente_id: @paciente.situacao_paciente_id, telefone: @paciente.telefone } }
